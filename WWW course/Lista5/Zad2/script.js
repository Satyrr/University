$(function () {
    var dialog, form, deleteDialog, rowToDelete, name = $("#name"), surname = $("#surname"), city = $("#city"), postcode = $("#postcode"), birthday = $("#birthday"), allFields = $([]).add(name).add(surname).add(city).add(postcode).add(birthday), tips = $(".validateTips");
