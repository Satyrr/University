$( function() {
    var dialog:any, form:any, deleteDialog:any, rowToDelete:any,
      ...
      allFields:any = $( [] ).add( name ).add( surname ).add( city ).add( postcode ).add( birthday ),
      tips:any = $( ".validateTips" );
    ...
    function checkLength( o:any, n:string, min:number, max:number ) {
    ...
    function checkRegexp( o:any, regexp:any, n:string ) {
    ...
    form = dialog.find( "form" ).on( "submit", function( event:Event ) {
